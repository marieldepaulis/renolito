      ...
      <div className="mx-auto max-w-3xl px-4 py-8 space-y-6">
        {offers.length === 0 ? (
          <div className="rounded-lg border border-dashed p-12 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">Volvé a revisar más tarde o contactá directamente con la producción.</p>
          </div>
        ) : (
          <>
        ...
        {submitted ? (
          <div className="flex items-center gap-3 rounded-lg bg-emerald-50 px-4 py-3 text-emerald-700">
            ...
            <div>
              ...
              <p className="text-xs">La producción revisará tu perfil y se contactará con vos.</p>
            </div>
          </div>
        ) : (
